...
const Subscribe = () => {
  return (
    <div className='px-3 sm:px-[100px] md:px-[140px] xl:px-[300px] py-10 bg-[#F7F7F7] font-poppins'>
      <div className='flex flex-col md:flex-row items-center justify-between gap-10'>
        <div className='text-center md:text-left'>
          <h1 className='text-[20px] sm:text-[22px] md:text-[22px] xl:text-[22px] leading-9 font-semibold'>
            Subscribe to our Newsletter
          </h1>
          <p className='text-[12px] md:text[10px] xl:text-[14px] leading-5 font-normal mt-1 text-[#999999]'>
        ...
        <div className='flex flex-col xl:flex-row items-center gap-4 w-full md:w-auto'>
          {/* Subscribe input */} 
          <div className='flex items-center bg-white rounded-full overflow-hidden border border-[#E6E6E6] w-full md:w-auto'>
            <input 
              type="text" 
              placeholder='Your email address' 
              className='outline-none p-3 text-gray-700 flex-1 min-w-[180px]' 
            />
            <button className='text-white text-[14px] font-semibold bg-[#00B207] py-[14px] px-9 rounded-full whitespace-nowrap'>
              Subscribe
            </button>
          </div>
