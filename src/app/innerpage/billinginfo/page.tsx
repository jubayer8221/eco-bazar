...
const BillingInfo = () => {
  ...
  return (
    <div className="pl-3 pr-3 py-3 sm:pl-[100px] sm:pr-[100px] md:pl-[140px] md:pr-[140px] xl:pl-[300px] xl:pr-[300px] flex flex-col xl:flex-row justify-between gap-3 font-poppins">
      {/* Billing Information */}
