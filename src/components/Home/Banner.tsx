...
const Banner = () => {
  return (
    <div className="pl-3 pr-3 sm:pl-[100px] sm:pr-[100px] md:pl-[140px] md:pr-[140px] xl:pl-[300px] xl:pr-[300px] xl:h-[500px] font-poppins flex flex-col md:flex-col xl:flex-row justify-between bg-white gap-4 mt-5">
      {/* Left Main Banner */}
