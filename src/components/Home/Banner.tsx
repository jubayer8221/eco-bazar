      ...
      <div className="md:w-1/3 w-full flex flex-col gap-4">
        ...
        <div className="relative">
          ...
          <div className="absolute top-6 left-6 text-black">
            <p className="text-[12px] md:text-[14px] font-medium">SUMMER SALE</p>
            <h3 className="text-[24px] md:text-[32px] font-semibold">75% OFF</h3>
            <p className="text-[12px] md:text-[14px] mt-1 text-[#666666]">Only Fruit & Vegetable</p>
            <button className="text-[14px] md:text-[16px] mt-2 font-medium text-[#00B207]">Shop now →</button>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-6 left-6 text-white">
            ...
            <h2 className="text-[20px] md:text-[28px] font-semibold">Special Products Deal of the Month</h2>
            <button className="text-[14px] md:text-[16px] mt-2 font-medium text-[#00B207]">Shop now →</button>
          </div>
        </div>
      </div>
